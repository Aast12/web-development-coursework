...
function createCard(data) {
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="card-title d-inline">${
                                data.name
                            } <small class="text-muted">#${data.pokemonId}</small></h3>
                        ...
                        <div class="row align-items-center">
                            <div class="col-5">
                                <img
                                    class="my-3"
                                    src="${`https://pokeres.bastionbot.org/images/pokemon/${data.pokemonId}.png`}"
                                    alt="pikachu"
    ...
    pokemon.set(data.pokemonId, data);
